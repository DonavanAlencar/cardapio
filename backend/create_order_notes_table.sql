...
INSERT IGNORE INTO `order_notes` (`order_id`, `notes`, `created_by`, `created_at`) VALUES
(1, 'Cliente solicitou que o hambúrguer seja bem passado', 1, NOW()),
(2, 'Pedido com urgência - cliente tem compromisso', 1, NOW()),
(3, 'Substituir queijo por queijo vegano', 1, NOW());
